...
class TestToolTemplate:
    ...
    def test_tool_minimal_features_structure(self, tool_minimal_dst):
        ...
        assert "source" in features["features"]["system__processes"]["conversion"]
        assert "value" in features["features"]["system__processes"]["conversion"]
...
class TestUseCaseTemplate:
    ...
    def test_use_case_minimal_features_structure(self, use_case_minimal_dst):
        ...
        assert "source" not in features["features"]["system__processes"]["conversion"]
        assert "value" in features["features"]["system__processes"]["conversion"]
