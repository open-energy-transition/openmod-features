...
To report a possible violation, contact the [lead maintainer](./GOVERNANCE.md#project-maintainers).
If the incident concerns the lead maintainer, reach out to the [Open Energy Transition Leadership](mailto:info@openenergytransition.org)
...
Project Maintainers will keep investigation and enforcement actions as transparent as possible while prioritizing safety and confidentiality.
...
If an investigation by the Project Maintainers finds that this Code of Conduct has been violated, the following enforcement ladder may be used to determine how best to repair harm, based on the incident's impact on the individuals involved and the community as a whole.
Depending on the severity of a violation, lower rungs on the ladder may be skipped.

1. Warning
   1. Event: A violation involving a single incident or series of incidents.
   1. Consequence: A private, written warning from the Project Maintainers.
...
1. Temporarily Limited Activities
   ...
   1. Consequence: A private, written warning with a time-limited cooldown period designed to underscore the seriousness of the situation and give the community members involved time to process the incident.
...
1. Permanent Ban
   ...
   1. Consequence: Access to all community spaces, tools, and communication channels is removed.
